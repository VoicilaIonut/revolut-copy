...
Tranzactie::Tranzactie(const std::string& ibanSender,
    const std::string& ibanRecipient, float value_,
    const Currency& currency_, bool realizata_)
